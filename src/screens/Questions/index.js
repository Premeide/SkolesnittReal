...
const QuestionsScreen = (props) => {
  return (
    <View style={GlobalStyles.container}>
      <ScrollView>
        <CollapseComponent title="Question?" text="ANSWER!!!" />
        <CollapseComponent
          title="Questddsadsadsaion?"
          height={100}
          text="Ofte stilte spørsmål Hvordan regner jeg ut snittet mitt?\n\n Enkelt og greit: snittet ditt er summen av alle dine karakterer,"
        />
        <CollapseComponent
          title="Questddsadsadsaion?"
          height={250}
          text="Ofte stilte spørsmål Hvordan regner jeg ut  sosiologi og sosialantropologi samt sosialkunnskap. {}
            Du vet at du trenger å forbedre snittet ditt og at medisinstudiet krever disse realfagene sosiologi og sosialantropologi samt sosialkunnskap. Du vet at du trenger å forbedre snittet ditt og at medisinstudiet krever disse realfagene snittet mitt?\n\n Enkelt og greit: snittet ditt er summen av alle dine karakterer,"
        />
        <CollapseComponent title="Question?" text="ANSWER!!!" />
        <CollapseComponent title="Question?" text="ANSWER!!!" />
